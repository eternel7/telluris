...
PRENOMS = {
    "humain": {
        "M": [
            ...
            "Niccolò", "Vittorio",
            "Armand", "Arnaud", "Aubin", "Baldric", "Bastien", "Borin",
            "Colin", "Durgan", "Elyas", "Étienne", "Gérard", "Grimbert",
            "Guillaume", "Gundar", "Hector", "Hervé", "Hugues", "Jehan",
            "Lysandre", "Martin", "Milo", "Nicolas", "Orik", "Oudin",
            "Perrin", "Rémi", "Robin", "Thorin", "Yves", "Aëron", "Faëlin",
            "Adrien", "Aimé", "Alain", "Alban", "Albert", "Albin", "Alex",
            "Alexandre", "Alexis", "Amédée", "André", "Ange", "Antoine",
            "Antonin", "Ariel", "Armel", "Arsène", "Auguste", "Augustin",
            "Aurélien", "Axel", "Aymeric", "Baptiste", "Barnabé", "Basile",
            "Benjamin", "Benoît", "Bérenger", "Bernard", "Bertin", "Brice",
            "Camille", "Cédric", "Charles", "Christian", "Christophe",
            "Claude", "Clément", "Constant", "Constantin", "Cyril", "Cyrille",
            "Damien", "Daniel", "David", "Denis", "Didier", "Dominique",
            "Donatien", "Dorian", "Edgard", "Edmond", "Édouard", "Éloi",
            "Émile", "Émilien", "Emmanuel", "Éric", "Erwan", "Eudes",
            "Eugène", "Évariste", "Fabien", "Fabrice", "Félix", "Ferdinand",
            "Flavien", "Florent", "Florian", "Francis", "Franck", "François",
            "Frédéric", "Gabriel", "Gaël", "Gaétan", "Gaspard", "Gaston",
            "Gauthier", "Geoffroy", "Georges", "Gérald", "Germain",
            "Ghislain", "Gilbert", "Gildas", "Gilles", "Gonzague", "Grégoire",
            "Gustave", "Guy", "Henri", "Herbert", "Honoré", "Hubert",
            "Jacques", "Jean", "Jean-Baptiste", "Jean-Louis", "Jean-Loup",
            "Jean-Luc", "Jean-Marie", "Jérémie", "Jérôme", "Joachim",
            "Jocelyn", "Joël", "Johan", "Joseph", "Jules", "Julien", "Justin",
            "Lambert", "Laurent", "Léon", "Léonard", "Léopold", "Lionel",
            "Loïc", "Louis", "Luc", "Lucien", "Ludovic", "Marc", "Marcel",
            "Marcelin", "Marin", "Martial", "Mathias", "Mathieu", "Mathis",
            "Matthias", "Matthieu", "Maurice", "Maxence", "Maxime",
            "Maximilien", "Michel", "Noël", "Norbert", "Olivier", "Pascal",
            "Patrice", "Patrick", "Paul", "Paulin", "Philippe", "Pierre",
            "Quentin", "Raphaël", "Raymond", "Régis", "Rémy", "René",
            "Rodolphe", "Rodrigue", "Roger", "Roland", "Romain", "Romuald",
            "Samuel", "Sébastien", "Serge", "Simon", "Stéphane", "Sylvain",
            "Sylvestre", "Tanguy", "Théodore", "Théophile", "Thibaud",
            "Thierry", "Timothée", "Tristan", "Valentin", "Valéry", "Victor",
            "Vincent", "Vivien", "Xavier", "Yann", "Yannick", "Yvon",
            "Zacharie", "Edoardo", "Tommaso", "Mattia", "Gabriele", "Riccardo",
            "Luca",
            "Hugo", "Mateo", "Leo", "Pablo", "Alejandro", "Enzo", "Yìchén",
            "Yǔxuān", "Hàoyú", "Yǔchén", "Zǐmò", "Yǔháng", "Hàorán", "Zǐháo",
            "Mùyáng", "Minato", "Iori", "Yuito", "Saku", "Ao",
            "Hinata", "Ran", "Ai"
        ],
        "F": [
            ...
            "Violante", "Ximena",
            "Adèle", "Aélis", "Aelwen", "Agnès", "Alix", "Berthe", "Clémence",
            "Colombe", "Élénor", "Éléonore", "Émeline", "Guillemette",
            "Isaline", "Jeanne", "Jehanne", "Mahaut", "Margot", "Maëlys",
            "Mélisande", "Nimiel", "Perrine",
            "Adeline", "Adrienne", "Agathe", "Aglaé", "Aimée", "Albane",
            "Alexandra", "Alexandrine", "Alexia", "Aliette", "Aline",
            "Alizée", "Amandine", "Ambre", "Amélie", "Anaïs", "Andrée",
            "Angèle", "Angeline", "Angélique", "Annabelle", "Annette",
            "Annick", "Annie", "Antoinette", "Ariane", "Arielle", "Arlette",
            "Armande", "Armelle", "Aude", "Aurélie", "Auriane", "Aurore",
            "Axelle", "Bénédicte", "Benjamine", "Benoîte", "Bérangère",
            "Bérengère", "Bérénice", "Bernadette", "Blandine", "Camille",
            "Capucine", "Carine", "Carole", "Caroline", "Cathy", "Cécile",
            "Céline", "Chantal", "Charlène", "Chimène", "Christèle",
            "Christelle", "Christiane", "Christine", "Claire", "Clarisse",
            "Claude", "Claudette", "Claudie", "Claudine", "Clémentine",
            "Colette", "Constance", "Coralie", "Corinne", "Danièle",
            "Danielle", "Daphné", "Delphine", "Denise", "Diane", "Dominique",
            "Doriane", "Dorothée", "Édith", "Edwige", "Éliane", "Élisabeth",
            "Élise", "Élodie", "Éloïse", "Émilie", "Emmanuelle", "Estelle",
            "Esther", "Eugénie", "Ève", "Évelyne", "Fabienne", "Fanny",
            "Faustine", "Flavie", "Flore", "Florence", "Florentine",
            "Floriane", "Florine", "France", "Françoise", "Frédérique",
            "Gabrielle", "Gaëlle", "Gaétane", "Garance", "Georgette",
            "Géraldine", "Germaine", "Ghislaine", "Guylaine", "Hélène",
            "Henriette", "Hortense", "Irène", "Isabelle", "Jacqueline",
            "Janine", "Jannick", "Jasmine", "Jeannette", "Jeannine", "Joanne",
            "Jocelyne", "Joëlle", "Johanne", "Josée", "Joséphine", "Josette",
            "Josiane", "Julie", "Julienne", "Juliette", "Justine", "Karine",
            "Laure", "Laurence", "Laurette", "Lauriane", "Léa", "Léonie",
            "Léopoldine", "Liliane", "Line", "Lise", "Louise", "Lucie",
            "Lucile", "Ludivine", "Lydie", "Madeleine", "Magali", "Manon",
            "Marianne", "Marie", "Marie-Ange", "Marie-Josée", "Marielle",
            "Marie-Lou", "Marine", "Marion", "Marjorie", "Martine",
            "Marylène", "Maryline", "Maryse", "Maryvonne", "Maud",
            "Maximilienne", "Mégane", "Mélanie", "Michèle", "Micheline",
            "Michelle", "Milène", "Mireille", "Monique", "Morgane", "Muriel",
            "Murielle", "Mylène", "Nadège", "Nadine", "Nathalie", "Nelly",
            "Nicole", "Noëlle", "Noémie", "Odile", "Ophélie", "Oriane",
            "Pascale", "Pascaline", "Patricia", "Paule", "Paulette",
            "Pauline", "Philippine", "Pierrette", "Rachel", "Raphaëlle",
            "Régine", "Réjane", "Renée", "Rolande", "Romane", "Rosalie",
            "Roseline", "Rosine", "Roxane", "Sabine", "Sandrine", "Sarah",
            "Ségolène", "Séverine", "Sibylle", "Simone", "Solange", "Solène",
            "Stéphanie", "Suzanne", "Sylvaine", "Sylviane", "Sylvie",
            "Thérèse", "Tiphaine", "Ursule", "Valérie", "Vanessa",
            "Véronique", "Victoire", "Violaine", "Virginie", "Viviane",
            "Yolande", "Yveline", "Zoé",
            "Sofia", "Giulia", "Aurora", "Alicia", "Charline", "Ginevra",
            "Beatricia", "Martina", "Vittoriana", "Francescina", "Oliviana",
            "Lucina", "Lara", "Alba", "Julia", "Daniela", "Maríana", "Yīnuò",
            "Xīnyí", "Zǐhán", "Xīnyán", "Kěxīn", "Yǔxī", "Yǔtóng",
            "Mèngyáo", "Sui", "Midori", "Himari", "Tsumugi", "Mashiro", "Rin",
            "Hina", "Koharu", "Iroha", "Uta", "Kotoha"
        ]
    },
    "elfe": {
        "M": [
...
NOMS = {
    "humain": [
		...
		"de Rochefort", "de Montfaucon", "Bâtisseur", "de Montmartre",
		"de Montreuil", "de Saint-Germain", "Pelletier", "de Villedieu",
		"Fournier", "de Brévannes", "Boucher", "de Chastel", "de Chevreuse",
		"de Valois", "Taillefort", "de Périgord", "de Provence", "Marchand",
		"Taillefer", "Cordier", "Fortbras", "Petitet", "de Montargis",
		"de Limoges", "Forgepierre", "de Beaumont", "de Rouvray", "Mercier",
		"Deschamps", "Doucebourse", "Poingdacier", "de Foix", "des Halles",
		"de Varenne", "des Prés", "de Montfort", "Renard", "de Champagne",
		"de Meaux", "de Belleville", "de Narbonne", "Lefèvre", "Grosbois",
		"de Normandie", "Grandmain", "de la Forge", "de la Roche", "Tissier",
		"de Saint-Victor", "de la Butte", "de la Porte", "Charpentier",
		"de Valmont", "de Villeneuve", "Pommeverte", "Lenoir", "de Charny",
		"Vautrin", "de Villiers", "de Lutèce", "de la Seine", "d'Orléans",
		"Bonfoyer", "de Béarn", "La Roche", "de Vaudreuil", "Ferrand",
		"Longpré", "de Vienne", "Piedléger", "Barbier", "Barbeforte",
		"de Châtillon", "Bonpain", "de Châtelet", "Bouchet", "Maçon",
		"de Saintonge", "du Marché", "Champfleuri", "Leclerc", "de Picardie",
		"Ferclou", "de Mirecourt", "Grosmarché", "Longchamp", "Maubert"
    ],
    "elfe": [
